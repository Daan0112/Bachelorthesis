...
def Calculate_variance2median(run, global_factor = 1.0):
    ...
    return [loss_S, loss_C, loss_R, loss_Tot_mem]
...
base_params = {'T_antigen': 14,
'initial_population': 1000,
'p_act': 0.3544861856097248,
'frac_memory': 0.6291643946742512,
'S_C_Ratio': 0.2886470595454168,
'p_SC': 6.202857443116558e-07,
'p_CR': 0.0019101951524058797,
'r_N': 0.033056716086499925,
'r_S': 0.025620096466033103,
'r_C': 0.0,
'r_R': 0.0,
'd_N': 6.36017405922311e-05,
'd_S': 0.00020701143096099874,
'd_C': 0.00015883029275603,
'd_R': 0.0861481693127616}


run = run_simulation(base_params)
variance = Calculate_variance2median(run,0.0085)
print(variance)
plot_model_vs_data(run, global_factor=0.0085)
...
def objective(trial):
    ...
    losses = Calculate_variance2median(model, global_factor=0.0085)
...
study.optimize(objective, n_trials=1000) # Run 100 "smart" simulations

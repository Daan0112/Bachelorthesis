...
from modelC2_variance import calculate_scale_and_RMSE
...
if __name__ == "__main__":
    study = optuna.load_study(study_name="yellowfever_250seeds_q25_contraction", storage="sqlite:///yellowfever_250seeds_q25_contraction.db")
    ...
    plot_sensitivity(sensitivity_data, filename="yellowfever_fit_sensitivity_q25_contraction.png")
import optuna
import modelB2_plot as plotter
import modelB2_multrun as multrun

study = optuna.load_study(study_name="yellowfever_250seeds_q25_ablation", storage="sqlite:///yellowfever_250seeds_q25_ablation.db")
...
plotter.plot_model_vs_data(m, low, high, params, saving="yellowfever_250seeds_q25_ablation.png")
print(params)
